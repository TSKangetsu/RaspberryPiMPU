...
inline void ICM42605DataSPIRead(int &Sensor_fd, int *Six_AxisData, int ICM42605_SPI_Freq)
{
    ...
    if (Tmp_ICM42605_SPI_BufferX[1] & 0x08)
    {
        ...
        uint8_t Tmp_ICM42605_SPI_Buffer[10] = {0};
        uint8_t Tmp_ICM42605_SPI_Bufferout[10] = {0};
        Tmp_ICM42605_SPI_Buffer[0] = 0x9f;
        {
            _s_spiXfer(Sensor_fd, Tmp_ICM42605_SPI_Buffer, Tmp_ICM42605_SPI_Bufferout, ICM42605_SPI_Freq, 10);
        ...
        {
            uint8_t Tmp_ICM42605_SPI_GBuffer[10] = {0};
            uint8_t Tmp_ICM42605_SPI_GBufferout[10] = {0};
            Tmp_ICM42605_SPI_GBuffer[0] = 0xa5;
            _s_spiXfer(Sensor_fd, Tmp_ICM42605_SPI_GBuffer, Tmp_ICM42605_SPI_GBufferout, ICM42605_SPI_Freq, 10);
